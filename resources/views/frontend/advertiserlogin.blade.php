                                ...
                                <div class="contact-form-validated form-one" action="inc/sendemail.php">
                                    <div class="login-page__group">
                                        ...
                                        <div class="login-page__input-box login-page__input-box--bottom">
                                            ...
                                            <a href="/forgetadvertizerpassword" class="login-page__form__forgot">forgot password?</a>
                                        </div>
                                        <div class="login-page__input-box">
                                            ...
                                            <div class="login-page__input-box__btn">
                                                <a href="{{ route('google.loginadvertizer') }}" class="rentol-btn rentol-btn__google"><img src="frontend/assets/images/shapes/google.png" alt> Or sign in with Google</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <p class="login-page__form__text">Dont have an account?<a href="/signupadvertiser">Sign up now</a></p>
                            </div>
                        </div>
                    </div>
                </div>
