                    ...
                    <div class="login-page__right wow fadeInRight" data-wow-duration='1500ms' data-wow-delay='500ms'>
                        <div class="login-page__login-box">
                            <div class="login-page__content">
                                ...
                                <form class="contact-form-validated form-one" action="{{ route('password.update') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="login-page__group">
                                        ...
                                        <div class="login-page__input-box">
                                            ...
                                            <input type="password" placeholder="Enter Password" id="password_confirmation" class="login-page__password" name="password_confirmation">
                                        </div>

                                        <div class="login-page__input-box">
                                            <div class="login-page__input-box__btn">
                                                <button type="submit" class="rentol-btn">Reset Password</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
