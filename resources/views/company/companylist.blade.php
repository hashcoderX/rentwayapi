                                                    ...
                                                    <div class="preview-item border-bottom">
                                                        ...
                                                        <div class="preview-item-content d-sm-flex flex-grow">
                                                            <div class="flex-grow">
                                                                ...
                                                                <p class="text-muted mb-0">{{ $company->contact_no }} / {{ $company->mobile_number }}</p>


                                                            </div>
                                                            <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                                                <p class="text-muted">Join Date - {{ $company->register_date }}</p>
                                                                <a class="btn btn-success" href="viewcompanydetails/{{ $company->id }}">More Details</a>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form id="updateCustomerForm" action="/updatecustomer" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Temporary Address</label>
                                    <textarea class="form-control" id="temporaryaddress" name="temporaryaddress"></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Telephone Number Two</label>
                                    <input type="text" class="form-control" id="telephone_number_two" name="telephone_number_two" placeholder="Telephone Number" style="color: gray;">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputUsername1">Telephone Number Three</label>
                                    <input type="text" class="form-control" id="telephone_number_three" name="telephone_number_three" placeholder="Telephone Number" style="color: gray;">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputUsername1">Telephone Number four</label>
                                    <input type="text" class="form-control" id="telephone_number_four" name="telephone_number_four" placeholder="Telephone Number" style="color: gray;">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputUsername1">Driving Licen Image (.png,jpg)</label>
                                    <input type="file" class="form-control" id="drivinglicensephoto" name="drivinglicensephoto" style="color: gray;">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputUsername1">Living Verification (.png,jpg)</label>
                                    <input type="file" class="form-control" id="livingverification" name="livingverification" style="color: gray;">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputUsername1">Customer Image (.png,jpg)</label>
                                    <input type="file" class="form-control" id="customerphoto" name="customerphoto" style="color: gray;">
                                </div>
    ...
    function getcustomerdetails(nic) {
        $.ajax({
            ...
            success: function(response) {
                ...
                document.getElementById('permanentaddress').value = response.customer.p_address;
                document.getElementById('temporaryaddress').value = response.customer.t_address;
                document.getElementById('telephone').value = response.customer.telephone_no;
                document.getElementById('telephone_number_two').value = response.customer.telephone_number_two;
                document.getElementById('telephone_number_three').value = response.customer.telephone_number_three;
                document.getElementById('telephone_number_four').value = response.customer.telephone_number_four;
            }
        });
    }
