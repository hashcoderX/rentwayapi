            ...
            <div class="card-body">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p class="card-text">Booking Dates - {{ $booking->book_start_date }}  {{ $booking->pick_time }} To {{ $booking->return_date }} . {{ $booking->return_time }}</p>
                ...
                <div class="media mt-2">
                    ...
                    <div class="media-body">
                        <p class="card-text mt-3">{{ Str::ucfirst($booking->full_name) }} ,Call {{ $booking->telephone_no }}</p>
                        <p class="card-text mt-3">NIC / Phone Number - {{ $booking->nic }}</p>
                       
                    </div>
                    <!-- <a href="/booking/editbooking/{{ $booking->id }}" class="btn btn-primary">Edit Booking</a> -->
                </div>
